...
INSERT INTO OWNER (firstname, lastname, vat, email, address, plate_number, brand) VALUES ('Leo', 'Tolstoy', '123456789', 'leo@gmail.gr', 'Othonos 3', 'ABC-1234', 'citroen');
INSERT INTO OWNER (firstname, lastname, vat, email, address, plate_number, brand) VALUES ('John', 'Steinbeck', '678912345', 'john@gmail.gr', 'Kanari 5', 'MIB-1135', 'bmw');
INSERT INTO OWNER (firstname, lastname, vat, email, address, plate_number, brand) VALUES ('Alexandros', 'Papadiamantis', '987654321', 'alex@gmail.gr', 'Leonidou 10', 'NIR-4567', 'mazda');
INSERT INTO OWNER (firstname, lastname, vat, email, address, plate_number, brand) VALUES ('Nikos', 'Kazantzakis', '111777222', 'nik@gmail.gr', 'Thermopulwn 37', 'KAB-2314', 'mercedes');
INSERT INTO OWNER (firstname, lastname, vat, email, address, plate_number, brand) VALUES ('Angelos', 'Terzakis', '555999888', 'ang@gmail.gr', 'Rhga Fereou 9', 'VIK-7215', 'citroen');
